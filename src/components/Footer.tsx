      ...
      <footer className="bg-black text-white py-20 text-center">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="footer-bottom mt-20 border-t border-gray-600 pt-12 flex flex-col items-center gap-8">
            ...
            >
              <Link href="#" className="text-black transition-all hover:scale-125"><Briefcase size={20} /></Link>
              <Link href="#" className="text-black transition-all hover:scale-125"><Mail size={20} /></Link>
              <Link href="#" className="text-black transition-all hover:scale-125"><MessageSquare size={20} /></Link>
              <Link href="#" className="text-black transition-all hover:scale-125"><Camera size={20} /></Link>
            </div>
